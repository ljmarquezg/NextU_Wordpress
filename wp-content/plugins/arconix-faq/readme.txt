...
[Documentation](http://docs.tychesoftwares.com/docs/faq/)
...
Use the `[faq]` shortcode in a widget or on a post/page. This will output the FAQ's using the default settings (Ascending order by Title in a Toggle configuration). If you'd like to use a different order, consult the [Documentation](http://docs.tychesoftwares.com/docs/faq/) for assistance.
...
* Visit the [documentation](http://docs.tychesoftwares.com/docs/faq/) for assistance
